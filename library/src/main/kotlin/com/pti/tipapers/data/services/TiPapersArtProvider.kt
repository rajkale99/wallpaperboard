...
@SuppressLint("NewApi")
open class TiPapersArtProvider : MuzeiArtProvider() {
    
    companion object {
        private const val SHARE_COMMAND_ID = 2
    }
    
    private val worker: TiPapersArtWorker by lazy { TiPapersArtWorker() }
    
    override fun onLoadRequested(initial: Boolean) {
        val configs = context?.let { TiPapersKonfigs(it) }
