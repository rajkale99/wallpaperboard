 ...
 */
package com.pti.tipapers.helpers.extensions
...
import com.pri.tipapers.helpers.extensions.dirSize
...
internal val Fragment.configs: TiPapersKonfigs
    get() = (activity as? ThemedActivity<TiPapersKonfigs>)?.configs
        ?: activity?.let { TiPapersKonfigs(it) }
        ?: context?.let { TiPapersKonfigs(it) }
        ?: TiPapersKonfigs(actv)
...
fun Context.clearDataAndCache() {
    ...
    clearCache()
    TiPapersKonfigs(this).downloadsFolder = getString(
