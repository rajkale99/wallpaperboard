 ...
 */
package com.pti.tipapers.helpers.glide
...
inline fun <reified T> quickListener(crossinline what: (T) -> Boolean): TiPapersGlideListener<T> {
    return object : TiPapersGlideListener<T>() {
...
abstract class TiPapersGlideListener<Type> : RequestListener<Type> {
 ...
 */
abstract class GlidePaletteListener : TiPapersGlideListener<Drawable>() {
