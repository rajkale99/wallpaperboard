...
import com.pti.tipapers.ui.adapters.CreditsAdapter
import com.pti.tipapers.ui.adapters.viewholders.Credit
...
open class CreditsActivity : ThemedActivity<TiPapersKonfigs>() {
    ...
    @StringRes
    open fun getDashboardTitle() = R.string.tipapers_dashboard
    ...
    open fun getTranslationSite(): String = "http://j.mp/Trnsl8TiPapers"
