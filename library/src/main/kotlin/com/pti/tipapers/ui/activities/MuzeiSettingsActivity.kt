...
import com.pti.tipapers.data.services.TiPapersArtProvider
...
import com.pti.tipapers.viewmodels.CollectionsViewModel
import com.pti.tipapers.viewmodels.WallpapersViewModel
...
class MuzeiSettingsActivity : ThemedActivity<TiPapersKonfigs>() {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val isTiPapersApp = boolean(R.bool.isTiPapers)
    ...
    private fun doFinish() {
        ...
        try {
            val intent = Intent(this, TiPapersArtProvider::class.java)
