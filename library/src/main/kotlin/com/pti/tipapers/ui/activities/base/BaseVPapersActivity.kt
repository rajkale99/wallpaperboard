 ...
 */
package com.pti.tipapers.ui.activities.base
...
import com.pti.tipapers.helpers.utils.ADW_ACTION
import com.pti.tipapers.helpers.utils.APPLY_ACTION
import com.pti.tipapers.helpers.utils.TiPapersKonfigs
import com.pti.tipapers.helpers.utils.ICONS_APPLIER
import com.pti.tipapers.helpers.utils.ICONS_PICKER
import com.pti.tipapers.helpers.utils.IMAGE_PICKER
import com.pti.tipapers.helpers.utils.MIN_TIME
import com.pti.tipapers.helpers.utils.NOVA_ACTION
import com.pti.tipapers.helpers.utils.PLAY_STORE_LINK_PREFIX
import com.pti.tipapers.helpers.utils.TURBO_ACTION
import com.pti.tipapers.helpers.utils.WALLS_PICKER
import com.pti.tipapers.viewmodels.IAPItem
import com.pti.tipapers.viewmodels.IAPViewModel
...
abstract class BaseTiPapersActivity<T : TiPapersKonfigs> : BaseWallpaperActionsActivity<T>(),
    ...
    private fun showDonationDialog(items: ArrayList<IAPItem>) {
        ...
        dialog = mdDialog {
            ...
            itemsSingleChoice(items) { _, which, _ ->
                billingProcessor?.purchase(this@BaseTiPapersActivity, items[which].id)
            }
