 ...
 */
package com.pti.tipapers.ui.adapters.viewholders
...
import com.pti.tipapers.helpers.extensions.createHeartIcon
import com.pti.tipapers.helpers.extensions.tilesColor
import com.pti.tipapers.helpers.glide.GlidePaletteListener
import com.pti.tipapers.helpers.glide.loadPicture
import com.pti.tipapers.helpers.glide.smoothAnimator
...
abstract class TiPapersViewClickListener<in T, in VH> {
...
abstract class TiPapersWallpaperHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
...
class CollectionHolder(itemView: View) : TiPapersWallpaperHolder(itemView) {
    ...
    fun setItem(
        ...
        listener: TiPapersViewClickListener<Collection, CollectionHolder>
               ) {
...
class WallpaperHolder(itemView: View, private val showFavIcon: Boolean) :
    TiPapersWallpaperHolder(itemView) {
    ...
    fun setItem(
        ...
        wallpaper: Wallpaper,
        check: Boolean,
        listener: TiPapersViewClickListener<Wallpaper, WallpaperHolder>
               ) {
        detailsBg?.background = null
        startLoading()
