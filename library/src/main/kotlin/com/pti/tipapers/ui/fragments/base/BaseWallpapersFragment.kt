 ...
 */
package com.pti.tipapers.ui.fragments.base
...
import com.pti.tipapers.ui.widgets.EmptyViewRecyclerView
import com.pti.tipapers.ui.widgets.EndlessRecyclerViewScrollListener
...
abstract class BaseWallpapersFragment : BaseTiPapersFragment<Wallpaper, WallpaperHolder>() {
    ...
    val wallsAdapter: WallpapersAdapter by lazy {
        WallpapersAdapter(
            ...
            object : TiPapersViewClickListener<Wallpaper, WallpaperHolder>() {
                ...
                override fun onLongClick(item: Wallpaper) {
                    ...
                    (activity as? BaseTiPapersActivity<*>)?.showWallpaperOptionsDialog(item)
                }
