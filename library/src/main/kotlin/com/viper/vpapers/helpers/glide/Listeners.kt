 ...
 */
package com.viper.vpapers.helpers.glide
...
inline fun <reified T> quickListener(crossinline what: (T) -> Boolean): VPapersGlideListener<T> {
    return object : VPapersGlideListener<T>() {
...
abstract class VPapersGlideListener<Type> : RequestListener<Type> {
 ...
 */
abstract class GlidePaletteListener : VPapersGlideListener<Drawable>() {
