...
import com.viper.vpapers.ui.adapters.CreditsAdapter
import com.viper.vpapers.ui.adapters.viewholders.Credit
...
open class CreditsActivity : ThemedActivity<VPapersKonfigs>() {
    ...
    @StringRes
    open fun getDashboardTitle() = R.string.vpapers_dashboard
    ...
    open fun getTranslationSite(): String = "http://j.mp/Trnsl8VPapers"
