...
import com.viper.vpapers.data.services.VPapersArtProvider
...
class MuzeiSettingsActivity : ThemedActivity<VPapersKonfigs>() {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val isVPapersApp = boolean(R.bool.isVPapers)
    ...
    private fun doFinish() {
        ...
        try {
            val intent = Intent(this, VPapersArtProvider::class.java)
