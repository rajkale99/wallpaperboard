...
import com.viper.vpapers.helpers.extensions.showChanges
import com.viper.vpapers.helpers.utils.ADW_ACTION
import com.viper.vpapers.helpers.utils.APPLY_ACTION
import com.viper.vpapers.helpers.utils.VPapersKonfigs
import com.viper.vpapers.helpers.utils.ICONS_APPLIER
import com.viper.vpapers.helpers.utils.ICONS_PICKER
import com.viper.vpapers.helpers.utils.IMAGE_PICKER
import com.viper.vpapers.helpers.utils.MIN_TIME
import com.viper.vpapers.helpers.utils.NOVA_ACTION
import com.viper.vpapers.helpers.utils.PLAY_STORE_LINK_PREFIX
import com.viper.vpapers.helpers.utils.TURBO_ACTION
import com.viper.vpapers.helpers.utils.WALLS_PICKER
import com.viper.vpapers.viewmodels.IAPItem
import com.viper.vpapers.viewmodels.IAPViewModel
...
abstract class BaseVPapersActivity<T : VPapersKonfigs> : BaseWallpaperActionsActivity<T>(),
    ...
    private fun showDonationDialog(items: ArrayList<IAPItem>) {
        ...
        dialog = mdDialog {
            ...
            itemsSingleChoice(items) { _, which, _ ->
                billingProcessor?.purchase(this@BaseVPapersActivity, items[which].id)
            }
